...
var showByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, order_1.OrderModel.showByUser(req.params.id)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [2 /*return*/];
...
var showByUserAndStatus = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, order_1.OrderModel.showByUserAndStatus(req.params.user_id, req.params.status_id)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [2 /*return*/];

...
var UserModel = /** @class */ (function () {
    ...
    UserModel.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, passwordDigest, result, createdUser, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new user ".concat(user.firstName, " ").concat(user.lastName, " Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UserModel.authenticate = function (user) {
        return __awaiter(this, void 0, void 0, function () {
